...
│   │
│   ├── system-service/         # RIÊNG (Dev C): Backend quản lý phân quyền & tổ chức (NestJS)
...
**Database:** `System_DB` – lưu trữ: Users, Roles, Permissions, Organizational Tree.
...
|---|---|---|---|
| **System_DB** | `system_db` | Users, Roles, Permissions, Org Tree | `packages/system-db` |
...
# SYSTEM DB
# ============================================
SYSTEM_DATABASE_URL="postgresql://system_user:system_pass@localhost:5432/system_db"
...
| **Backend Services** | NestJS + gRPC (Protobuf) | 10 / 20 LTS |
