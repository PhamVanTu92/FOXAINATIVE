...
public class RollbackDocumentCommandHandler : IRequestHandler<RollbackDocumentCommand, KnowledgeDocumentDto>
{
    private readonly IKnowledgeDocumentRepository _repo;
    private readonly IUnitOfWork _uow;

    public RollbackDocumentCommandHandler(IKnowledgeDocumentRepository repo, IUnitOfWork uow)
    {
        _repo = repo;
        _uow = uow;
    }

    public async Task<KnowledgeDocumentDto> Handle(RollbackDocumentCommand cmd, CancellationToken ct)
    {
