...
public class SubmitDocumentForReviewCommandHandler
    : IRequestHandler<SubmitDocumentForReviewCommand, KnowledgeDocumentDto>
{
    private readonly IKnowledgeDocumentRepository _repo;
    private readonly IUnitOfWork _uow;

    public SubmitDocumentForReviewCommandHandler(IKnowledgeDocumentRepository repo, IUnitOfWork uow)
    {
        _repo = repo;
        _uow = uow;
    }

    public async Task<KnowledgeDocumentDto> Handle(SubmitDocumentForReviewCommand cmd, CancellationToken ct)
    {
