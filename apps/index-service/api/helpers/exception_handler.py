...
class ExceptionHandler(BaseModel):
    ...
    def handle_created(self, output: dict) -> JSONResponse:
        """Handle resource created (201)

        Args:
            output (dict): output data containing created resource information

        Returns:
            Response: response object with 201 status
        """
        data = {'info': output}
    ...
    def handle_accepted(self, output: dict) -> JSONResponse:
        """Handle accepted (202) - for async operations

        Args:
            output (dict): output data containing task information

        Returns:
            Response: response object with 202 status
        """
        data = {'info': output}
    ...
    def handle_unauthorized(self, message: Optional[str] = None, extra: Optional[dict] = None) -> JSONResponse:
    ...
    def handle_forbidden(self, message: Optional[str] = None, extra: Optional[dict] = None) -> JSONResponse:
