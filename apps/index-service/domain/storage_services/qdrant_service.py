...
class QdrantService(BaseModel):
    ...
    async def seed(self, data: List[Any], collection_name: str, document_type: DocumentType = DocumentType.STRUCTURED, metadata: Optional[Dict[str, Any]] = None) -> None:
    ...
    async def seed_sentence(self, data: List[Any], collection_name: str, metadata: Optional[Dict[str, Any]] = None) -> None:
